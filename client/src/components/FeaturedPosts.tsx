	...
	return (
		<div className="mt-8 flex flex-col lg:flex-row gap-8">
			...
			<div className="w-full lg:w-1/2 flex flex-col gap-4">
				...
				{/*    标题*/}
				<Link to="/test" className="text-xl lg:text-3xl font-semibold lg:font-blod">
					Lorem dsf sdfin sdif ei fsdim g
				</Link>
			</div>
			{/*其他*/}
			<div className="w-full lg:w-1/2 flex flex-col gap-4">
				...
				<div className="lg:h-1/3 flex justify-between gap-4">
					...
					<div className="w-2/3">
						...
						<Link to="/test" className="text-base sm:text-xl md:text-2xl lg: text-xl xl: text-2xl font-medium">
							Lorem dsf sdfin sdif ei fsdim g Lorem dsf sdfin sdif ei fsdim g Lorem dsf sdfin sdif ei fsdim g
						</Link>
					</div>
				</div>
				<div className="lg:h-1/3 flex justify-between gap-4">
